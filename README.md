...
Drop in a photo and it's cleaned up automatically. Everything runs locally:
...
- **White balance** _(always on)_ — neutralizes a warm or cool colour cast so
  whites read as natural white light.
...
上傳相片後即自動整理。所有處理皆在本機完成：**不需上傳、不用登入、不會追蹤。**
